document.addEventListener('DOMContentLoaded', () => {
    ...
    const radioButtons = document.querySelectorAll('input[name="jenis-kelamin"]');
//
    ...
    const updateSubmitButtonStatus = () => {
        ...
        btnSubmit.disabled = !(allFilled && genderSelected);
    };
    ...
    btnSubmit.addEventListener('click', (event) => {
        ...
        if (allFilled && genderSelected) {
            ...
            const weight = parseFloat(inputFields[1].value); // Berat badan dalam kg
            const heightCm = parseFloat(inputFields[2].value); // Tinggi badan dalam cm
